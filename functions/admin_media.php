...
/**
 * Normalizar filenames dos uploads
 * 
 * @link https://wpartisan.me/plugins/wpa-filename-sanitizer
 * 
 */
add_filter( 'sanitize_file_name', 'boros_sanitize_file_name', 10, 1 );
function boros_sanitize_file_name( $filename ) {
     ...
     */
    $sanitized_filename = apply_filters( 'boros_sanitize_file_name', $sanitized_filename, $filename );
