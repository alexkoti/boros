...
function admin_styles(){
	...
	wp_enqueue_style( 'form_elements', BOROS_CSS . 'form-elements.css' , false, '1.0', 'screen' );
}
...
?>
	...
	$editor_attr = array(
		...
		'buttons3' => '',
		'height' => 150,
		'css' => get_stylesheet_directory_uri() . '/css/site.css,' . get_stylesheet_directory_uri() . '/css/wym-editor.css',
	);
