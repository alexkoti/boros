...
function admin_styles(){
	...
	//CUSTOM STYLES
	wp_enqueue_style( 'custom_admin_css', BOROS_CSS . 'admin.css' , array(), BOROS_VERSION, 'screen' );
	wp_enqueue_style( 'events', BOROS_CSS . 'events.css' , array(), BOROS_VERSION, 'screen' );
	wp_enqueue_style( 'form_elements', BOROS_CSS . 'form_elements.css' , array(), BOROS_VERSION, 'screen' );
}
...
function add_custom_admin_scripts(){
	...
	foreach( $scripts as $script ){
		wp_enqueue_script( $script, BOROS_JS . $script . '.js', array('jquery'), BOROS_VERSION );
	}
