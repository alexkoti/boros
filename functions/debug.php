...
/**
 * Teste de colunas.
 * Verificar no github a quantidade de colunas de código que o github exibe no navegador
...
111111111122222222223333333333444444444455555555556666666666777777777788888888889999999999000000000011111111112222222222<<<< limite de 120 colunas do github web, 17/04/2014
 * 
 */
...
class PRE {
	...
	private function do_css(){
		...
		.pre_box_head {background:#ededed;color:#da1c23;cursor:pointer;font-size:14px;font-weight:normal;margin:0;padding:5px;}
