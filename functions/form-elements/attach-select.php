...
class BFE_attach_select extends BorosFormElement {
	...
	function set_input( $value = null ){
		...
		// Verificar se o post já possui alguma imagem anexada. Caso positivo, será exibido o botão de selecionar entre as existentes e mudar o texto link de adicionar imagens
		...
		<div class="attach_select" id="<?php echo "attach_select_{$input_name}"; ?>">
			...
			<div class="attach_select_view_actions hide-if-no-js <?php echo $actions_class; ?>">
				<a class="thickbox btn-action btn-action-new" href="<?php echo $new_link; ?>" <?php echo $dataset;?>><?php echo $send_string; ?></a> &nbsp; &nbsp; 
				<a class="thickbox btn-action btn-action-select" href="<?php echo $select_link; ?>" <?php echo $dataset;?>>Escolher entre os anexos existentes</a>
			</div>
		</div>
		<?php
