...
class BFE_special_image extends BorosFormElement {
	 ...
	 * $layout        - modelo de exibição: 
     *                  large(imagem em cima, botões em baixo), 
     *                  row(imagem à esquerda, botões ao lado), 
     *                  grid(imagem em cima, botões icones em baixo, caixa pequena com float)
	 */
	...
	if( !empty($attch_id) ){
		...
		if( !empty($image) ){
            ...
            // calcular a altura proporcinalmente à largura
                ...
                // caso seja svg, não terá dimensões
